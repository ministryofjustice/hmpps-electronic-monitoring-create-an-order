...
export default class CurfewTimetableFormComponent extends FormComponent {
  ...
  shouldBeDisplayed(entries?: string[]): void {
    ...
    allEntries.forEach((day: string, index: number) => {
      ...
      this.day(day).getByLabel(/Main address/).should('exist')
      this.day(day).getByLabel(/Second address/).should('exist')
      this.day(day).getByLabel(/Third address/).should('exist')
  ...
  shouldBeDisabled(entries?: string[]): void {
    ...
    allEntries.forEach((day: string, index: number) => {
      ...
      this.day(day).getByLabel(/Main address/).should('be.disabled')
      this.day(day).getByLabel(/Second address/).should('be.disabled')
      this.day(day).getByLabel(/Third address/).should('be.disabled')
  ...
  shouldBeEmpty(entries?: string[]): void {
    ...
    allEntries.forEach((day: string) => {
      ...
      this.day(day).getByLabel(/Main address/).should('be.empty')
      this.day(day).getByLabel(/Second address/).should('be.empty')
      this.day(day).getByLabel(/Third address/).should('be.empty')
    })
  }
