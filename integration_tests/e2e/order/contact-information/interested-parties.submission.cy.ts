  ...
  context('Interested parties', () => {
    context('Submitting valid data', () => {
      ...
      context('DDv5 feature set to true', () => {
        ...
        it('should submit a form with the Magistrate Court set as City of Westminster Magistrates Court International Office', () => {
          cy.task('stubCemoGetOrder', {
            httpStatus: 200,
            id: mockOrderId,
            status: 'IN_PROGRESS',
          ...
          cy.task('stubCemoSubmitOrder', {
            ...
            response: {
              ...
              notifyingOrganisationEmail: 'magistrates@court',
              responsibleOrganisation: 'HOME_OFFICE',
              responsibleOrganisationEmail: 'responsible@organisation',
              responsibleOrganisationRegion: '',
              responsibleOfficerName: 'name',
          ...
          const formData = {
            notifyingOrganisation: 'Magistrates Court',
            notifyingOrganisationEmailAddress: 'magistrates@court',
            magistratesCourt: 'City of Westminster Magistrates Court International Office',
        ...
        it('should submit a form with the Youth Court set as Liverpool Youth Court (Hatton Garden)', () => {
          cy.task('stubCemoGetOrder', {
            httpStatus: 200,
            id: mockOrderId,
            status: 'IN_PROGRESS',
          ...
          cy.task('stubCemoSubmitOrder', {
            ...
            response: {
              ...
              notifyingOrganisationName: 'LIVERPOOL_YOUTH_COURT_HATTON_GARDEN',
              notifyingOrganisationEmail: 'youth@court',
              responsibleOrganisation: 'HOME_OFFICE',
              responsibleOrganisationEmail: 'responsible@organisation',
              responsibleOrganisationRegion: '',
              responsibleOfficerName: 'name',
          ...
          const formData = {
            notifyingOrganisation: 'Youth Court',
            notifyingOrganisationEmailAddress: 'youth@court',
            youthCourt: 'Liverpool Youth Court (Hatton Garden)',
            responsibleOrganisation: 'Home Office',
            responsibleOrganisationEmailAddress: 'responsible@organisation',
            responsibleOfficerName: 'name',
            responsibleOfficerContactNumber: '01234567891',
