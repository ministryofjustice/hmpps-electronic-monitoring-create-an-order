    ...
    it('Should successfully submit the order to the FMS API', () => {
      ...
      cy.task('verifyFMSCreateDeviceWearerRequestReceived', {
        ...
        body: {
          ...
          address_4: fakePrimaryAddress.addressLine4,
          ...
          secondary_address_4: fakeSecondaryAddress.addressLine4,
          ...
          compliance_and_enforcement_person_reference: deviceWearerDetails.complianceAndEnforcementPersonReference,
          court_case_reference_number: deviceWearerDetails.courtCaseReferenceNumber,
