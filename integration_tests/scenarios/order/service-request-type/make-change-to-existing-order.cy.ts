...
context('Service-Request-Types', () => {
  ...
  const fillInVariations = (variationType: string, receiptType: string, variation = variationDetails) => {
    ...
    Page.verifyOnPage(DeviceWearerCheckYourAnswersPage, 'Check your answers').saveAndReturn()
    orderSummaryPage.riskInformationTask.click()
    Page.verifyOnPage(InstallationAndRiskCheckYourAnswersPage, 'Check your answers').saveAndReturn()
    orderSummaryPage.electronicMonitoringTask.click()
    Page.verifyOnPage(MonitoringConditionsCheckYourAnswersPage, 'Check your answers').saveAndReturn()
