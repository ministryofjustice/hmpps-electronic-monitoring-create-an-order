...
context('The kitchen sink', () => {
  ...
  it('Fill in everything "including the kitchen sink" and screenshot', () => {
    ...
    cy.screenshot('29. alcoholMonitoringPage - validation', { overwrite: true })
    ...
    cy.screenshot('30. alcoholMonitoringPage', { overwrite: true })
    alcoholMonitoringPage.form.saveAndContinueButton.click()
    ...
    cy.screenshot('31. submitSuccessPage', { overwrite: true })
    submitSuccessPage.backToYourApplications.click()

    indexPage = Page.verifyOnPage(IndexPage)
    cy.screenshot('32. indexPageAfterSubmission', { overwrite: true })
