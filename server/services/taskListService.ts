...
export default class TaskListService {
  ...
  getTasks(order: Order, formData: FormData = {}): Array<Task> {
    ...
    tasks.push({
      ...
      required:
        order.addresses.some(({ addressType }) => addressType === AddressTypeEnum.Enum.SECONDARY) ||
        formData.hasAnotherAddress === true,
      status: 'INCOMPLETE',
    })
    ...
    tasks.push({
      ...
      required:
        order.addresses.some(({ addressType }) => addressType === AddressTypeEnum.Enum.TERTIARY) ||
        formData.hasAnotherAddress === true,
      status: 'INCOMPLETE',
    })
