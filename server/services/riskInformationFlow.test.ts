...
describe('getRiskInformationFlow', () => {
  ...
  it.each([
    ...
    ['CIVIL_COUNTY_COURT', courtPages, { mode: 'FIXED', offenceType: 'VIOLENCE_AGAINST_THE_PERSON' }],
    ['CROWN_COURT', courtPages, { mode: 'FIXED', offenceType: 'VIOLENCE_AGAINST_THE_PERSON' }],
    ['MAGISTRATES_COURT', courtPages, { mode: 'FIXED', offenceType: 'VIOLENCE_AGAINST_THE_PERSON' }],
    ['MILITARY_COURT', courtPages, { mode: 'FIXED', offenceType: 'VIOLENCE_AGAINST_THE_PERSON' }],
    ['SCOTTISH_COURT', courtPages, { mode: 'FIXED', offenceType: 'VIOLENCE_AGAINST_THE_PERSON' }],
    ['YOUTH_COURT', courtPages, { mode: 'FIXED', offenceType: 'VIOLENCE_AGAINST_THE_PERSON' }],
    [
      'HOME_OFFICE',
