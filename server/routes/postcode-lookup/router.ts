...
const createPostcodeLookupRouter = (): Router => {
  ...
  router.get('/confirm-address/:addressType', asyncMiddleware(findAddressController.view))
  router.post('/confirm-address/:addressType', asyncMiddleware(findAddressController.update))
