const paths = {
  ORDER: {
    ...
    UPDATE_ORDER_OWNER: '/order/:orderId/update-order-owner',
  },

  INTEREST_PARTIES: {
    BASE_PATH: '/order/:orderId/(version/:versionId/)?interest-parties',
    NOTIFYING_ORGANISATION: '/order/:orderId/interest-parties/notifying-organisation',
    SENTENCING_ACT_SELECTION: '/order/:orderId/interest-parties/sentencing-act-selection',
  ...
  MONITORING_CONDITIONS: {
    ...
    ZONE_NEW_ITEM: '/order/:orderId/monitoring-conditions/add-to-list/zone/:zoneType',
    ZONE_ADD_TO_LIST: '/order/:orderId/monitoring-conditions/add-to-list/zone/:zoneType/:zoneId',
