import PossibleRisks from '../../../types/i18n/reference/possibleRisks'

const possibleRisks: PossibleRisks = {
  ...
  NO_RISK: 'There are no risks that the installer should be aware of',
}
