import NotifyingOrganisationPageContent from '../../../types/i18n/pages/notifyingOrganisation'

const notifyingOrganisationPageContent: NotifyingOrganisationPageContent = {
  helpText: '',
  legend: '',
  questions: {
    prison: {
  ...
  title: "Notifying Organisation's details",
}
