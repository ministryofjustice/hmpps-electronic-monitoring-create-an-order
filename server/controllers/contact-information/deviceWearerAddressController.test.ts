...
describe('DeviceWearerAddressController', () => {
  ...
  beforeEach(() => {
    ...
    mockDeviceWearerAddressService = new DeviceWearerAddressService(mockRestClient) as jest.Mocked<DeviceWearerAddressService>
  ...
  describe('get', () => {
    it('should render the form using the saved contact details data', async () => {
      ...
      // When
      await deviceWearerAddressController.get(req, res, next)

      // Then
      expect(res.render).toHaveBeenCalledWith(
        'pages/order/contact-information/addresses',
